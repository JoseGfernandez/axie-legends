...
export const AXIES_DATA = {
    ...
    kibo: {
        ...
        modelo: '/axie-3d-assets/assets/mascots/kibo.glb',
        color: '#44aaff',
        escala: 1.05,
    ...
    kotaro: {
        ...
        modelo: '/axie-3d-assets/assets/mascots/kotaro.glb',
        color: '#ff8844',
        escala: 1.15,
    ...
    paladill: {
        ...
        modelo: '/axie-3d-assets/assets/mascots/paladill.glb',
        color: '#aa66ff',
        escala: 1.0,
    ...
    pomodoro: {
        ...
        modelo: '/axie-3d-assets/assets/mascots/pomodoro.glb',
        color: '#44ff88',
        escala: 1.0,
    ...
    tripp: {
        ...
        modelo: '/axie-3d-assets/assets/mascots/tripp.glb',
        color: '#ff66aa',
        escala: 1.1,
    ...
    xia: {
        ...
        modelo: '/axie-3d-assets/assets/mascots/xia.glb',
        color: '#ffdd44',
        escala: 1.1,
